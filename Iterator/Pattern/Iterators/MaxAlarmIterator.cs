...
public class MaxAlarmIterator : IIterator
{
    ...
    public MaxAlarmIterator(ITankCollection tankCollection)
    {
        _tanks = tankCollection.GetTanks().OrderByDescending(t => t.GetAlarmCodes().Count).ToArray();
        _currentPosition = 0;
